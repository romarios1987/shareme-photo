					...
					<div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
						...
						{!imageAsset ? (
							<label>
								<div className='flex flex-col items-center justify-center h-full'>
									<div className='flex flex-col justify-center items-center'>
										<p className='fond-bold text-2xl'>
							...
							<div className='relative h-full'>
								...
								<button
									type='button'
									className='flex items-center justify-center absolute bottom-3 right-3 rounded-full w-10 h-10 bg-white text-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out'
